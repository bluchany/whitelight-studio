...
const CLASSES = [
    {
        ...
        bgScale: "h-full",
        bgPosition: "bottom-0 right-0 md:right-12",
        ...
        portfolioText: "김수안 강사님의 통기타 연주와 스튜디오 작업물들을\n직접 확인해보세요.",
        portfolioBtn: "작업물 듣기"
    },
    {
        id: "bass-minkc-t",
        ...
        imagePosition: "object-top scale-[1.5] origin-[center_30%]",
        bgScale: "h-full",
        bgPosition: "bottom-0 right-0 md:right-12",
        ...
        portfolioText: "민경찬 강사님의 베이스 연주와 작업물들을\n직접 확인해보세요.",
        portfolioBtn: "작업물 보기"
    },
    {
        id: "vocal-leeyj-t",
        ...
        portfolioText: "이윤진 강사님의 보컬 커버와 작업물들을\n직접 확인해보세요.",
        portfolioBtn: "작업물 보기"
    },
    {
        id: "midi-ohsh-t",
        category: "MIDI & E.GUITAR CLASS",
        instructor: "오승환",
        image: "/images/OhSW_T.svg",
        modalImage: "/images/crew_shcord.jpg",
        bgImage: "/images/crew_shcord_N.png",
        imagePosition: "object-top",
        bgScale: "h-full",
        bgPosition: "bottom-0 right-0 md:right-12",
        subtitle: "나만의 음악을 스케치하고 완성하는 과정",
        lessonInfo: "1:1 Private & Group Lesson",
        about: ["레슨 소개 내용은 추후 업데이트될 예정입니다."],
        process: ["준비 중입니다."],
        portfolioUrl: "https://www.instagram.com/reel/C8MxRJ-yB3-/?igsh=MWR2YXN0bHRoODlycQ==",
        portfolioText: "오승환 강사님의 기타 연주와 프로듀싱 작업물들을\n직접 확인해보세요.",
        portfolioBtn: "작업물 보기"
    },
    {
        id: "voice-hanej-t",
        category: "VOICE ACTOR CLASS",
        instructor: "한이정",
        image: "/images/HanEJ_T_2.svg",
        modalImage: "/images/HanEJ_T.png",
        bgImage: "/images/HanEJ_T_N.png",
        imagePosition: "object-top",
        bgScale: "h-full",
        bgPosition: "bottom-0 right-0 md:right-12",
        subtitle: "캐릭터에 생명력을 불어넣는 목소리",
        lessonInfo: "1:1 Private & Group Lesson",
        about: ["레슨 소개 내용은 추후 업데이트될 예정입니다."],
        process: ["준비 중입니다."],
        portfolioUrl: "https://www.youtube.com/@hanleejeong",
        portfolioText: "한이정 강사님의 성우 작업물들을\n직접 확인해보세요.",
        portfolioBtn: "작업물 보기"
    },
    {
        id: "vocalmusic-jungjr-t",
        category: "VOCAL MUSIC CLASS",
        instructor: "정주리",
        image: "/images/JungJR_T_2.svg",
        modalImage: "/images/JungJR_T.png",
        bgImage: "/images/JungJR_T_N.png",
        imagePosition: "object-top",
        bgScale: "h-full",
        bgPosition: "bottom-0 right-0 md:right-12",
        subtitle: "목소리의 깊이를 더하는 성악 발성",
        lessonInfo: "1:1 Private & Group Lesson",
        about: ["레슨 소개 내용은 추후 업데이트될 예정입니다."],
        process: ["준비 중입니다."],
        portfolioUrl: "https://www.youtube.com/watch?v=IF65sByvFxA",
        portfolioText: "정주리 강사님의 성악 커버와 작업물들을\n직접 확인해보세요.",
        portfolioBtn: "작업물 보기"
    },
    {
        id: "flute-parkig-t",
        category: "FLUTE CLASS",
        instructor: "박인국",
        image: "/images/ParkIG_T_2.svg",
        modalImage: "/images/ParkIG_T.png",
        bgImage: "/images/ParkIG_T_N.png",
        imagePosition: "object-top",
        bgScale: "h-full",
        bgPosition: "bottom-0 right-0 md:right-12",
        subtitle: "청아한 음색으로 마음을 사로잡는 플룻",
        lessonInfo: "1:1 Private & Group Lesson",
        about: ["레슨 소개 내용은 추후 업데이트될 예정입니다."],
        process: ["준비 중입니다."],
        portfolioUrl: "https://www.youtube.com/@박인국-t3t",
                            ...
                            <div className="flex flex-col lg:flex-row w-full min-h-[60vh] lg:min-h-[70vh]">
                                ...
                                <div className="w-full lg:w-2/5 bg-neutral-50 p-6 sm:p-10 md:p-12 lg:p-16 flex flex-col items-center border-b lg:border-b-0 lg:border-l border-black/5 order-1 lg:order-2">
                                    ...
                                    <div className="w-40 h-56 sm:w-48 sm:h-64 md:w-56 md:h-72 bg-white rounded-sm overflow-hidden shadow-2xl border-[6px] border-white mb-8 sm:mb-10 shrink-0 relative mt-6 lg:mt-0">
                                        <img
                                            src={selectedInstructor.modalImage || selectedInstructor.image}
