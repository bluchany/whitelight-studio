                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10 flex flex-col-reverse lg:flex-row items-center justify-between gap-12 lg:gap-20">
                    ...
                    >
                        ...
                        <h1 className="text-4xl md:text-6xl lg:text-7xl font-black tracking-tighter text-black mb-10 break-keep leading-[1.1]">
                            리듬과 화성의 중심,<br className="md:hidden" /> 베이스 <br className="hidden lg:block lg:pb-2" />솔루션
                        </h1>
                        <div className="flex flex-col md:flex-row items-center justify-center lg:justify-start gap-4 md:gap-8 mt-2">
                            <p className="text-xl md:text-2xl font-black tracking-widest text-neutral-800">Inst. 민경찬</p>
                    ...
                    >
                        <div className="w-56 h-72 md:w-64 md:h-[22rem] lg:w-72 lg:h-[26rem] bg-neutral-100 rounded-t-full rounded-b-xl overflow-hidden shadow-2xl border-[6px] border-white relative group shrink-0">
                            <img
                                src="/images/Minkc_T.png"
                                alt="Instructor Min Kyung-chan"
                                className="w-full h-full object-cover object-[center_5%] scale-[1.7] origin-top filter grayscale transition-all duration-700 mix-blend-multiply group-hover:grayscale-0"
                            />
                        </div>
                    </motion.div>
                </div>
